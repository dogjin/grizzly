...
TEST_CASE("Waveform")
{
    SECTION("sine")
    {
        SECTION("bipolar")
        {
            CHECK(generateSine<float>(-0.25) == Approx(-1));
            CHECK(generateSine<float>(0) == Approx(0));
            CHECK(generateSine<float>(0.125) == Approx(0.7071067812));
            CHECK(generateSine<float>(0.25) == Approx(1));
            CHECK(generateSine<float>(0.375) == Approx(0.7071067812));
            CHECK(generateSine<float>(0.5) == Approx(0));
            CHECK(generateSine<float>(0.625) == Approx(-0.7071067812));
            CHECK(generateSine<float>(0.75) == Approx(-1));
            CHECK(generateSine<float>(0.875) == Approx(-0.7071067812));
            CHECK(generateSine<float>(1) == Approx(0));
            CHECK(generateSine<float>(1.25) == Approx(1));
        }

        SECTION("unipolar")
        {
            CHECK(generateUnipolarSine<float>(-0.25) == Approx(0));
            CHECK(generateUnipolarSine<float>(0) == Approx(0.5));
            CHECK(generateUnipolarSine<float>(0.125) == Approx(0.85355339059328));
            CHECK(generateUnipolarSine<float>(0.25) == Approx(1));
            CHECK(generateUnipolarSine<float>(0.375) == Approx(0.85355339059328));
            CHECK(generateUnipolarSine<float>(0.5) == Approx(0.5));
            CHECK(generateUnipolarSine<float>(0.625) == Approx(0.14644660940672));
            CHECK(generateUnipolarSine<float>(0.75) == Approx(0));
            CHECK(generateUnipolarSine<float>(0.875) == Approx(0.14644660940672));
            CHECK(generateUnipolarSine<float>(1) == Approx(0.5));
            CHECK(generateUnipolarSine<float>(1.25) == Approx(1));
        }
    }
    ...
    SECTION("saw")
    {
        SECTION("bipolar")
        {
            CHECK(generateSaw<float>(-0.25) == Approx(-0.5));
            CHECK(generateSaw<float>(0) == Approx(0));
            CHECK(generateSaw<float>(0.125) == Approx(0.25));
            CHECK(generateSaw<float>(0.25) == Approx(0.5));
            CHECK(generateSaw<float>(0.375) == Approx(0.75));
            CHECK(generateSaw<float>(0.5) == Approx(-1));
            CHECK(generateSaw<float>(0.625) == Approx(-0.75));
            CHECK(generateSaw<float>(0.75) == Approx(-0.5));
            CHECK(generateSaw<float>(0.875) == Approx(-0.25));
            CHECK(generateSaw<float>(1) == Approx(0));
            CHECK(generateSaw<float>(1.25) == Approx(0.5));
        }
    ...
    SECTION("triangle")
    {
        SECTION("bipolar")
        {
            CHECK(generateTriangle<float>(-0.25) == Approx(-1));
            CHECK(generateTriangle<float>(0) == Approx(0));
            CHECK(generateTriangle<float>(0.125) == Approx(0.5));
            CHECK(generateTriangle<float>(0.25) == Approx(1));
            CHECK(generateTriangle<float>(0.375) == Approx(0.5));
            CHECK(generateTriangle<float>(0.5) == Approx(0));
            CHECK(generateTriangle<float>(0.625) == Approx(-0.5));
            CHECK(generateTriangle<float>(0.75) == Approx(-1));
            CHECK(generateTriangle<float>(0.875) == Approx(-0.5));
            CHECK(generateTriangle<float>(1) == Approx(0));
            CHECK(generateTriangle<float>(1.25) == Approx(1));
        }
